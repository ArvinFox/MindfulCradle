...
class EnvironmentalMasteryPage extends StatefulWidget {
  const EnvironmentalMasteryPage({super.key});

  @override
  State<EnvironmentalMasteryPage> createState() =>
      _EnvironmentalMasteryPageState();
}

class _EnvironmentalMasteryPageState extends State<EnvironmentalMasteryPage> {
  bool _started = false;
  ...
  Future<void> _loadJson(String lang) async {
    try {
      ...
      setState(() {
        final provider = Provider.of<PWS18Provider>(context, listen: false);
        final ids = provider.subscales['Environmental Mastery'] ?? [];
      ...
      if (kDebugMode) print("Environmental Mastery JSON load error: $e");
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          _currentLang == 'en' ? 'Environmental Mastery' : 'පාරිසරික පාලනය',
              ...
              onPressed: !_allAnswered(provider) || _isSubmitting
                  ...
                  : () async {
                      ...
                      try {
                        ...
                        if (kDebugMode)
                          print("Error saving Environmental Mastery: $e");
                      } finally {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              _currentLang == 'en'
                  ? "Environmental Mastery Questions"
                  : "පාරිසරික පාලනය ප්‍රශ්න",
