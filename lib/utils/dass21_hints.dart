...
/// Shows the DASS-21 hint as a full-screen dialog that covers the entire screen
/// (including the parent AppBar/TabBar when embedded in a TabBarView).
class DASS21HintOverlay {
  static Future<void> show(
    ...
    await showGeneralDialog(
      ...
      barrierLabel: 'DASS21 Hint',
      barrierColor: Colors.black.withOpacity(0.55),
      transitionDuration: const Duration(milliseconds: 350),
      pageBuilder: (ctx, _, __) => _DASS21HintContent(
        onClose: () {
...
class _DASS21HintContent extends StatefulWidget {
  final VoidCallback onClose;
  const _DASS21HintContent({required this.onClose});

  @override
  State<_DASS21HintContent> createState() => _DASS21HintContentState();
}

class _DASS21HintContentState extends State<_DASS21HintContent>
