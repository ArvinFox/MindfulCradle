...
class PurposeInLifePage extends StatefulWidget {
  const PurposeInLifePage({super.key});

  @override
  State<PurposeInLifePage> createState() => _PurposeInLifePageState();
}

class _PurposeInLifePageState extends State<PurposeInLifePage> {
  bool _started = false;
  ...
  Future<void> _loadJson(String lang) async {
    try {
      ...
      setState(() {
        final provider = Provider.of<PWS18Provider>(context, listen: false);
        final ids = provider.subscales['Purpose in Life'] ?? [];
      ...
      if (kDebugMode) print("Purpose in Life JSON load error: $e");
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          _currentLang == 'en' ? 'Purpose in Life' : 'ජීවිතයේ අරමුණ',
              ...
              onPressed: !_allAnswered(provider) || _isSubmitting
                  ...
                  : () async {
                      ...
                      try {
                        ...
                        if (kDebugMode)
                          print("Error saving Purpose in Life: $e");
                      } finally {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              _currentLang == 'en'
                  ? "Purpose in Life Questions"
                  : "ජීවිතයේ අරමුණ ප්‍රශ්න",
