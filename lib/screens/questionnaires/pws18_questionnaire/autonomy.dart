...
class AutonomyPage extends StatefulWidget {
  ...
  @override
  State<AutonomyPage> createState() => _AutonomyPageState();
}
...
class _AutonomyPageState extends State<AutonomyPage> {
  ...
  Future<void> _loadJson(String lang) async {
    try {
      ...
      setState(() {
        final provider = Provider.of<PWS18Provider>(context, listen: false);
        final ids = provider.subscales['Autonomy'] ?? [];
      ...
      if (kDebugMode) print("Autonomy JSON load error: $e");
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          _currentLang == 'en' ? 'Autonomy' : 'ස්වයංක්‍රමතාව',
      ...
      body: _questions.isEmpty
          ...
          : !_started
          ? _buildStartScreen(langProvider)
          : Padding(
                                              ...
                                              SizedBox(
                                                ...
                                                child: ElevatedButton(
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    // close dialog and Autonomy page
                                                    Navigator.of(
                                                      context,
                                                    ).pop(); // close dialog
                                                    Navigator.of(
                                                      context,
                                                    ).pop(); // go back to category selection
                                                  },
                                                  child: Text(
                                                    _currentLang == 'en'
                                                        ? "OK"
  ...
  Widget _buildStartScreen(LanguageProvider langProvider) {
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _currentLang == 'en'
                  ? "This section measures your sense of autonomy in life."
                  : "මෙම කොටස ඔබේ ස්වයංක්‍රමතාවය මැනීමටයි.",
              textAlign: TextAlign.center,
