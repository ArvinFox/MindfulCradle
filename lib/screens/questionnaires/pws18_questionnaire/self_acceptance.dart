...
class SelfAcceptancePage extends StatefulWidget {
  const SelfAcceptancePage({super.key});

  @override
  State<SelfAcceptancePage> createState() => _SelfAcceptancePageState();
}

class _SelfAcceptancePageState extends State<SelfAcceptancePage> {
  bool _started = false;
  ...
  Future<void> _loadJson(String lang) async {
    try {
      ...
      setState(() {
        final provider = Provider.of<PWS18Provider>(context, listen: false);
        final ids = provider.subscales['Self-Acceptance'] ?? [];
      ...
      if (kDebugMode) print("Self-Acceptance JSON load error: $e");
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          _currentLang == 'en' ? 'Self-Acceptance' : 'ස්වයං පිළිගැනීම',
              ...
              onPressed: !_allAnswered(provider) || _isSubmitting
                  ...
                  : () async {
                      ...
                      try {
                        ...
                        if (kDebugMode)
                          print("Error saving Self-Acceptance: $e");
                      } finally {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              _currentLang == 'en'
                  ? "Self-Acceptance Questions"
                  : "ස්වයං පිළිගැනීම ප්‍රශ්න",
