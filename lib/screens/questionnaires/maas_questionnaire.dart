...
class _MAASPageState extends State<MAASPage> {
  ...
  Future<void> _loadJson(String lang) async {
    try {
      final path = lang == 'en' ? 'languages/maas_en.json' : 'languages/maas_si.json';
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(
                  langProvider.currentLang == 'en' ? "Start Feedback" : "ප්‍රතිචාර ආරම්භ කරන්න",
                  style: const TextStyle(fontSize: 16, color: AppColors.buttonText),
                ),
              ),
            ),
          ],
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            langProvider.currentLang == 'en' ? 'MAAS Feedback' : 'MAAS ප්‍රතිචාර',
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (qIndex >= _questions.length) return const SizedBox();
                                    ...
                                    children: [
                                      ...
                                      ..._options.entries.map(
                                        (entry) => RadioListTile<int>(
                                          ...
                                          onChanged: (val) {
                                            if (val != null) provider.setAnswer(qIndex + 1, val);
                                          },
                                        ),
                                      ),
                                    ],
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Text(
                                      langProvider.currentLang == 'en' ? 'Previous' : 'පෙර පිටුව',
                                      style: const TextStyle(fontSize: 15, color: AppColors.buttonText),
                                    ),
                                  ),
                                ),
                              ),
                                      ...
                                      : () async {
                                          ...
                                          if (_currentPage < totalPages - 1) {
                                            ...
                                            try {
                                              ...
                                              final maasScore = provider.calculateMAASScore();
                                              final classification = provider.classifyScore(maasScore);
                                                        ...
                                                        children: [
                                                          ...
                                                          SizedBox(
                                                            ...
                                                            child: ElevatedButton(
                                                              ...
                                                              child: Text(
                                                                langProvider.currentLang == 'en' ? "OK" : "හරි",
                                                                style: const TextStyle(fontSize: 16, color: AppColors.buttonText),
                                                              ),
                                                            ),
                                                          ),
                                  ...
                                  child: _isSubmitting
                                      ...
                                      : Text(
                                          _currentPage < totalPages - 1
                                              ? (langProvider.currentLang == 'en' ? 'Next' : 'ඊළඟ')
                                              : (langProvider.currentLang == 'en' ? 'Submit' : 'සබ්මිට්'),
                                          style: const TextStyle(fontSize: 15, color: AppColors.buttonText),
                                        ),
                                ),
                              ),
